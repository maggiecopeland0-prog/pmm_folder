...
folder-training/
│
├── SKILL.md                          ← The skill (full ICM methodology)
...
│   ├── _config/                         Shared reference
│   │   ├── voice.md                        Tone, formatting, good/bad samples
│   │   ├── terminology.md                  Required/forbidden terms, product names
│   │   └── audiences.md                    Audience profiles, mixed-audience rules
│   ├── release-notes/                   Workspace
│   │   ├── CONTEXT.md                      Stage contract: Slack posts, product updates
│   │   └── output/
│   ├── enablement-decks/                Workspace
│   │   ├── CONTEXT.md                      Stage contract: Training decks, FAQ docs
│   │   └── output/
│   └── event-prep/                      Workspace
│       ├── CONTEXT.md                      Stage contract: Briefs, talking points
│       └── output/
│
...
│   ├── _config/
│   │   ├── voice.md                        Template with example structure
│   │   ├── terminology.md                  Template with correction log
│   │   └── audiences.md                    Template with profile format
│   ├── workspace-1/
│   │   ├── CONTEXT.md                      Generic stage contract template
│   │   └── output/
│   ├── workspace-2/
│   │   └── ...
│   └── workspace-3/
...
│
├── setup/
│   └── questionnaire.md             ← 21-question interview guide
│
└── docs/
    ├── design-principles.md          ← The 5 design principles explained
