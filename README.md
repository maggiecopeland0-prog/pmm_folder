...
The thinking behind this system didn't come from a framework doc. It came from reading widely across AI, design, systems, and critical theory — and noticing the same tension everywhere: how things are supposed to work versus how they actually do.

<img src="assets/bookshelf.png" width="480" alt="Books on Maggie's shelf: Co-Intelligence, Looking Awry, The Design of Everyday Things, The Utopia of Rules, Weapons of Math Destruction" />

| Book | Author | Why it matters here |
|------|--------|---------------------|
| *Co-Intelligence* | Ethan Mollick | AI as collaborator, not replacement. The practical frame underneath everything in this repo. |
| *The Design of Everyday Things* | Donald A. Norman | Mental models and affordances. If a tool requires instructions to operate, the design failed. Same goes for AI context systems. |
| *Weapons of Math Destruction* | Cathy O'Neil | Why claims need to be earned. Precision over hype is not a style preference — it's an ethical one. |
| *The Utopia of Rules* | David Graeber | On bureaucracy and the hidden politics of process. Staying skeptical of complexity for its own sake. |
| *Looking Awry* | Slavoj Žižek | The oblique angle that reveals what a straight look misses. Sometimes the product story is better told from the side. |
