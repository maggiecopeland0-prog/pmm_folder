...
```
Layer 0: CLAUDE.md .............. "Where am I?"        (identity + rules)
Layer 1: CONTEXT.md ............. "Where do I go?"     (task routing)
Layer 2: Stage CONTEXT.md ....... "What do I do?"      (process + format)
Layer 3: _config/ files ......... "What rules apply?"  (voice, terms, audiences)
Layer 4: Working inputs ......... "What am I working with?" (per-run material)
```
...
├── LICENSE               ← MIT
│
├── example/              ← Working example: PMM workspace (filled in)
│   ├── CLAUDE.md
│   ├── CONTEXT.md
│   ├── _config/
│   │   ├── voice.md
...
│   └── event-prep/
│
├── template/             ← Blank template: fork and fill in
│   ├── CLAUDE.md
│   ├── CONTEXT.md
│   ├── _config/
│   │   ├── voice.md
...
│
├── setup/
│   └── questionnaire.md  ← Interview guide for building a new workspace
│
└── docs/
